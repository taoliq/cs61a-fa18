...
# The WallAnt class
class WallAnt(Ant):
	"""WallAnt does nothing each turn just with a large armor value"""
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        if target and target.can_scared:
            target.can_scared = False
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self, hive):
        ...
        while current_place:
            ant = current_place.ant
            while ant and ant is not self:
                if ant:
                    insects2dis[ant] = current_distance
                if ant.is_container:
                    ant = ant.contained_ant
                    insects2dis[ant] = current_distance
                else:
            ...
            for bee in current_place.bees:
                insects2dis[bee] = current_distance
